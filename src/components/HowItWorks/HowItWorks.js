...
function HowItWorks() {
  const IntroductionSection = () => (
    <section sx={{ maxWidth: "600px", marginTop: "32px" }}>
  ...
  return (
    <div className="howItWorks__container howItWorks bg-gray-100 w-full h-full mt-16">
      ...
      <Banner
        ...
        text="Usbnex is free and was initially created to support configuration software for the Ryval keyboard. Our most important concern when using the latest web technologies is the protection, security, and integrity of the devices we support. We will never sell your data."
      />
      <TwoColumn />
        ...
        <div className="relative">
          <div className="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-24">
            ...
            <div className="sm:mt-16">
              <div className="pl-4 max-w-xl  -mr-48 sm:pl-6 md:-mr-16 lg:py-32 lg:relative ">
      ...
      <Banner text="Usbnex is free and was initially created to support configuration software for the Ryval keyboard. Our most important concern when using the latest web technologies is the protection, security, and integrity of the devices we support. We will never sell your data." />
